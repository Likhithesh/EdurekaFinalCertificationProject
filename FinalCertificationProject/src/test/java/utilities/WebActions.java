...
public class WebActions implements AutomationConst{
...
//		Screenshot_Utility.CaptureScreenshot_ExtentReport(driver, SCREENSHOT_PATH, "DemoBlaze_AlertMessage");
//		WebActions.takeScreenshot(driver, "DemoBlaze_AlertMessage");
