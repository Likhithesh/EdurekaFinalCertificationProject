...
public class ExcelUtility {
	/*
	 * public static void main(String args[]) throws IOException { Object[][]
	 * myData=ExcelUtility.readFromExcel("testdata/mytestdata.xlsx",
	 * "Registration"); for(int i=0;i<myData.length;i++) { for(int
	 * j=0;j<myData[i].length;j++) { System.out.println(myData[i][j]); } } }
	 * 
	 */
